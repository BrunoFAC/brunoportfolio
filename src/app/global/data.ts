...
export const cardsData: ProjectProps[] = [
  ...
  },
  {
    ...
    type: "personal",
    label:
      "Responsive e-commerce website, featuring profile management, order history, filters, favorites, shopping cart, and purchase transactions.",
...

  {
    ...
    label:
      "Built a portfolio from scratch using styled-components for styling.",
